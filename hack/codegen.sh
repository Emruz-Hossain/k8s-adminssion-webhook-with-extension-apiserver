...
PACKAGE_NAME=k8s-admission-webhook-with-extension-apiserver
...
docker run --rm -ti -u $(id -u):$(id -g) \
  ...
  k8s-admission-webhook-with-extension-apiserver/client \
  k8s-admission-webhook-with-extension-apiserver/apis \
  kubecar:v1alpha1 \
